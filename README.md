...
- Hemisphere-flavored prompts are injected automatically (left = structured/causal, right = imagistic/motif-rich) so API replies stay “brain-like” while still integrating shared context.
