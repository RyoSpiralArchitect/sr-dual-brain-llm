...
To turn any benchmark JSON report into a short Markdown brief:
`python3 sr-dual-brain-llm/scripts/summarize_benchmark_report.py path/to/report.json --output path/to/report.md`.
